...
import { ImportLinkFunctionIcon } from '@/components/ui/icons/imort-link-function-icon ';
    ...
    <View className="flex-1 bg-white">
      ...
      <SafeAreaView className="flex-1">
        ...
        <View className="items-center justify-center px-5">
          <ImportLinkFunctionIcon />
        </View>

        <View className="px-7">
          <Text className="text-center  font-garamond text-[25px] text-black">
            Paste the link of the Fanfiction you want to import
          </Text>
